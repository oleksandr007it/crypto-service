...
import com.idevhub.crypto.web.rest.util.HeaderUtil;
...
public class ExceptionTranslator implements ProblemHandling {
    ...
    public ResponseEntity<CryptoServiceServiceErrorVM> handleCryptoServiceException(CryptoServiceException ex, NativeWebRequest request) {
        return new ResponseEntity<>(ex.createErrorVM(), CryptoServiceException.httpStatus);
    }
